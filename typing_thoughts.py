...
save_path_cnn = './Checkpoints/cnn'
save_path_rnn = './Checkpoints/rnn'
save_path_ae = './Checkpoints/ae'
...
final=200*10 #Total number of datapoints to take
all=all[0:final]
...
while step < 100:
    ...
    step+=1
saver.save(sess=sess3,save_path=save_path_cnn)
print("\n-------------CNN Trained------------------\n\n")
...
with tf.Session() as sess:
    ...
    saver.save(sess=sess,save_path=save_path_rnn)
    print("-------------------RNN Trained--------------------")
